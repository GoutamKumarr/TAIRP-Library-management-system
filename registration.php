...
<nav class="navbar navbar-inverse">
  <div class="container-fluid">
      ...
      <ul class="nav navbar-nav navbar-right">
        ...
        <li><a href="registration."><span class="glyphicon glyphicon-user"> SIGN UP</span></a></li>
      </ul>
    ...
    <div class="box2">
      ...
      <form name="Registration" action="" method="">
        ...
        <div class="login">
          ...
          <input class="btn btn-default" type="submit" name="submit" value="Sing up" style="color: black; width: 70px; height: 30px"> 
